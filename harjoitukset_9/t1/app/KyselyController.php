...
class KyselyController extends Controller
{
    ...
    // $allscorelist
    // Haetaan lista kaikista kirjautuneen opiskelijan tehtäväpalautuksista
...
SQLEND;
    ...
    // $sumscorelist
    // lasketaan ehdotettujen, hyväksyttyjen ja maksimipisteiden summat
...
SQLEND;
    ...
    // $totalsumscorelist
    // lasketaan kaikkien tarjolla olevien tehtävien maksimipisteet
    // opintojakson harjoitustehtäväarvosanan laskemista varten
    $sql = <<< SQLEND
...
SQLEND;
    ...
    // $pendingsumscorelist
    // lasketaan ehdotettujen, ei-vielä-hyväksyttyjen ja maksimipisteiden summat
    // opintojakson 
    $sql = <<< SQLEND
    SELECT sum(tpalautus.initpoints) as ipoints, sum(tpalautus.finalpoints) as fpoints,
               sum(tspec.maxpist) as mpoints
